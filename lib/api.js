...
class WishPopAPI {
  ...
  async getWishlistItems(params = {}) {
    ...
    const endpoint = `/api/p/688a4a52e2f530af6381409f/function/wishlistApi${queryString ? `?${queryString}` : ''}`;
  ...
  async addWishlistItem(item) {
    return this.request('/api/p/688a4a52e2f530af6381409f/function/wishlistApi', {
      method: 'POST',
